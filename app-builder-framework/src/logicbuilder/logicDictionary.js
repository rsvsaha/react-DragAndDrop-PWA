export const logicDictionary = {
    ...
    "MathBlocks" : {
        "evaluateMath": [{ type: "text", fieldName: "VariableNameForExpression", hint: "Enter the name of the variable which contains the expression" },
        { type: "text", fieldName: "VariableNameForResult", hint: "Enter the name of the variable where the value will be assigned to" }],
